...
const TradeCard: React.FC<TradeCardProps> = ({ trade }) => {
  ...
  const getStatusColor = (status: string) => {
    switch (status.toLowerCase()) {
      ...
      case 'settled':
        return 'bg-barclays-blue text-white';
      case 'pending':
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="flex-1 flex items-center justify-center space-x-2 px-4 py-2 bg-barclays-blue text-white rounded-md hover:bg-barclays-blue-dark transition-colors"
          >
