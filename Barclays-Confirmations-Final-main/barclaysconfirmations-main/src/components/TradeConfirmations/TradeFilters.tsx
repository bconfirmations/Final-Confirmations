      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-barclays-blue focus:border-transparent"
          />
        </div>
        ...
        <select
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-barclays-blue focus:border-transparent"
        >
