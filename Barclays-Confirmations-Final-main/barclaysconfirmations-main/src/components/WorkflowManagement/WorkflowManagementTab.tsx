          ...
          <div className="flex space-x-2">
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                chartType === "bar"
                  ? "bg-barclays-blue text-white border border-barclays-blue"
              ...
              <div className="flex space-x-2 mt-2 md:mt-0">
                {["legal", "trading", "sales"].map((tab) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors border focus:outline-none focus:ring-2 focus:ring-barclays-blue ${
                      escalationTab === tab
                        ? "bg-barclays-blue text-white border-barclays-blue shadow-sm"
            ...
            {filteredEscalationTrades.length > 1 && (
              <div className="mb-4 flex items-center space-x-2">
                ...
                <select
                  ...
                  className="px-3 py-1 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-barclays-blue focus:border-transparent"
                >
