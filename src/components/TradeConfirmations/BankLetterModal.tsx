...
const BankLetterModal: React.FC<BankLetterModalProps> = ({ trade, onClose }) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const htmlContent = `
      ...
      <html>
      <head>
        <title>TradeBank Trade Confirmation - ${trade.tradeId}</title>
        <style>
      ...
      <body>
        <div class="content">
          <div class="header">
            <div class="logo">TRADEBANK PLC</div>
          ...
          <div class="footer">
            ...
            <p>This confirmation is issued in accordance with the terms and conditions governing trading relationships between TradeBank PLC and the counterparty. This document constitutes a legally binding confirmation of the trade details specified herein.</p>
            ...
            <p>This trade is subject to the standard terms and conditions of TradeBank PLC and applicable regulatory requirements including but not limited to MiFID II, EMIR, and relevant local regulations.</p>
            <br>
            <div style="text-align: right;">
              <p><strong>TRADEBANK PLC</strong></p>
              <p>Trade Confirmation Department</p>
    ...
    a.href = url;
    a.download = `tradebank-confirmation-${trade.tradeId}.html`;
        ...
        <div className="p-8 bg-white">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <h1 className="text-3xl font-bold text-blue-900">TRADEBANK PLC</h1>
            </div>
          ...
          <div className="flex justify-between items-end mt-8 pt-6 border-t border-gray-300">
            ...
            <div className="text-right">
              <p className="font-bold text-gray-900">TRADEBANK PLC</p>
              <p className="text-gray-600">Trade Confirmation Department</p>
...
export default BankLetterModal;